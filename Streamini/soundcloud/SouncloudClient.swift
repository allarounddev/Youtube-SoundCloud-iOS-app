...
extension Session {
    ...
    */
    ...
    public static func login(in displayViewController: UIViewController, completion: @escaping (SimpleAPIResponse<Session>) -> Void) {
    ...
    */
    public func me(completion: @escaping (SimpleAPIResponse<SoundCloudUser>) -> Void) {
...
//    }
    ...
    public typealias ResolveResponse = (users: [SoundCloudUser]?, tracks: [Track]?, playlist: Playlist?)
    ...
    */
    public static func resolve(URI: String, completion: @escaping (SimpleAPIResponse<ResolveResponse>) -> Void) {
        ...
        let request = Request(url: url, method: .get, parameters: parameters, parse: {
            ...
            let users = $0.flatMap { SoundCloudUser(JSON: $0) }
