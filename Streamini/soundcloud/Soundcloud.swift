...
public class var clientIdentifier: String? {
    get {
...
public class var clientSecret: String? {
    get {
 ...
 */
public func login(in displayViewController: UIViewController, completion: @escaping (SimpleAPIResponse<Session>) -> Void) {
