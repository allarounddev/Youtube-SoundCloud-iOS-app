...
public extension Track {
    ...
    static let BaseURLNewSongs = URL(string:"https://api-v2.soundcloud.com/charts?kind=trending&genre=soundcloud%3Agenres%3Aall-music")!
    ...
    @discardableResult
    public static func searchTrending(queries: [SearchQueryOptions], completion: @escaping (PaginatedAPIResponse<Track>) -> Void) -> CancelableOperation? {
        guard let clientIdentifier = SoundcloudClient.clientIdentifier else {
            completion(PaginatedAPIResponse(error: .credentialsNotSet))
            return nil
        }
        ...
        let request = Request(url: BaseURLNewSongs, method: .get, parameters: parameters, parse: { JSON -> Result<PaginatedAPIResponse<Track>, SoundcloudError> in
...
//        #endif
     ...
     */
    @discardableResult
    public static func favoriters(of trackIdentifier: Int, completion: @escaping (PaginatedAPIResponse<SoundCloudUser>) -> Void) -> CancelableOperation? {
        guard let clientIdentifier = SoundcloudClient.clientIdentifier else {
            completion(PaginatedAPIResponse(error: .credentialsNotSet))
            return nil
        }
     ...
     */
    @discardableResult
    public func favoriters(completion: @escaping (PaginatedAPIResponse<SoundCloudUser>) -> Void) -> CancelableOperation? {
    ...
    @discardableResult
    @available(tvOS, unavailable)
    func unfavorite(completion: @escaping (SimpleAPIResponse<Bool>) -> Void) -> CancelableOperation? {
        #if !os(tvOS)
